...
5. On the dialog, open the **Add Filter** drop down and select **Availability** to add it to the filters.
   
    ![Add Availability](step1-addavailability.png)

6. Now open the value help of the *Availability* filter and choose only the value *In stock*.
   
    ![Select In Stock](step1-addavailabilityvaluefilter.png)
...
11. Before you proceed, save your changes in a new version. Version names can help you keep track of what was done in different versions. Open the version menu on the left of the top toolbar, choose **Activate New Version** and name it *Added In Stock View*. Only key users can see version names - they are not visible nor relevant to end users. Press **Confirm** to activate the new version.
...
6. You can easily check if your URL is correct by pressing **Show Preview**.
 ...
 7. If everything looks good, press **Save**. This will close the dialog and you will see the new section with the search results for the product name.

    ![Search Results Section](step2-searchresults.png)

 8. Finally, let's activate a new version with this new section. Open the version menu in the toolbar, choose **Activate New Version**, name it *Added Search Results* and press **Confirm**. You can now leave key user adaptation by pressing the **X** button on the top right of the toolbar and try out the application with your adaptations.

    > Some systems do not support versioning. In this case, just press the **Save** icon, and exit key user adaptation.
